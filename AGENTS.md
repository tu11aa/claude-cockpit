...
This project is indexed by GitNexus as **claude-cockpit** (448 symbols, 849 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
