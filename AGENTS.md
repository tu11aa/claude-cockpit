...
This project is indexed by GitNexus as **squadrant** (4074 symbols, 6036 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
