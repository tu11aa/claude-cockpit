...
This project is indexed by GitNexus as **claude-cockpit** (466 symbols, 890 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
